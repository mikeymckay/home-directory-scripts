...
# allows mistyped directory names to get fixed
shopt -s cdspell
...
if [[ -z "$DISPLAY" ]] ; then PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\[\033[01;31m\]\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ ' ; fi
...
alias xscreensaver-text='xscreensaver-text --program fortune'
...
# Let windows key emulate mouse click
#xmodmap -e "keycode 115 = Pointer_Button1"
#xkbset m

alias sshnohost='ssh -oUserKnownHostsFile=/dev/null -oStrictHostKeyChecking=no'
